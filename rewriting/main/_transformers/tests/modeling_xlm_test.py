...
if is_torch_available():
    from _transformers import (XLMConfig, XLMModel, XLMWithLMHeadModel, XLMForQuestionAnswering,
                               XLMForSequenceClassification, XLMForQuestionAnsweringSimple)
    from _transformers.modeling_xlm import XLM_PRETRAINED_MODEL_ARCHIVE_MAP
else:
