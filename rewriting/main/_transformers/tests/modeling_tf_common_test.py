...
if is_tf_available():
    ...
    import numpy as np
    from _transformers import TFPreTrainedModel
    ...
    class TFCommonModelTester(unittest.TestCase):
        ...
        def test_pt_tf_model_equivalence(self):
            ...
            for model_class in self.all_model_classes:
                ...
                pt_model_class = getattr(_transformers, pt_model_class_name)
                ...
                tf_model = _transformers.load_pytorch_model_in_tf2_model(tf_model, pt_model, tf_inputs=inputs_dict)
                pt_model = _transformers.load_tf2_model_in_pytorch_model(pt_model, tf_model)
                ...
                with TemporaryDirectory() as tmpdirname:
                    ...
                    tf_model = _transformers.load_pytorch_checkpoint_in_tf2_model(tf_model, pt_checkpoint_path)

                    tf_checkpoint_path = os.path.join(tmpdirname, 'tf_model.h5')
                    tf_model.save_weights(tf_checkpoint_path)
                    pt_model = _transformers.load_tf2_checkpoint_in_pytorch_model(pt_model, tf_checkpoint_path)
