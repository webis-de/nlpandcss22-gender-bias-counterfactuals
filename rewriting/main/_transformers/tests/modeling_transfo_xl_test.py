...
if is_torch_available():
    import torch
    from _transformers import (TransfoXLConfig, TransfoXLModel, TransfoXLLMHeadModel)
    from _transformers.modeling_transfo_xl import TRANSFO_XL_PRETRAINED_MODEL_ARCHIVE_MAP
else:
