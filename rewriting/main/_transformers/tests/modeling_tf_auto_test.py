...
from _transformers import is_tf_available

if is_tf_available():
    from _transformers import (AutoConfig, BertConfig,
    ...
    from _transformers.modeling_tf_bert import TF_BERT_PRETRAINED_MODEL_ARCHIVE_MAP
